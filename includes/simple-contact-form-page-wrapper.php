...
<div>
<input type="text" id="simple_contactform_label" name="simple_contactform_label" value="" placeholder="Type label here" required>
<select id="simple_contactform_select_element" name="simple_contactform_select_element" required> 
...
<input type="checkbox" id="simple_contactform_required" name="simple_contactform_required" value="required" required> Required
